...
var webinarForm = document.querySelector(".book-session-form");
var webinarDetails = document.querySelectorAll(".form-control");
var webinarFormName = document.querySelector("h1");
var webinarFormDay = document.getElementById("SelectedDate");

function getTimeSlotValue(){
    var radios = document.querySelector("input[name=choose-time]:checked").value;
    radioValue = radios;
...
webinarForm.addEventListener("submit", (e)=>{
    e.preventDefault();
    const firstName = webinarDetails[0].value;
    const email = webinarDetails[1].value;
    const phone = webinarDetails[2].value;
    const query = webinarDetails[3].value;
    const date = webinarFormDay.innerText;
    const exactTime = getTimeSlotValue();;
    const webinarName = webinarFormName.innerText;
    sendEmail(firstName, email, phone, query, webinarName, date, exactTime);
    webinarForm.reset();
})

var sendEmail = (firstname, email, phone, query, formName, date, time) =>{
    ...
    Email.send({
        ...
        Subject : `New Submission from ${formName} Form`,
        Body : `<tbody>
        <tr>
                        ...
                        <tbody>
                            <tr>
                                <td width="45%" bgcolor="#ffffff" style="text-align:left">
                                    ...
                                    <img src="https://drive.google.com/uc?export=view&id=1agEDvtnEHXkIQM_Nm90HtdP1jVN1H-cE"
                                ...
                                <td width="100%" valign="top" bgcolor="#ffffff" style="text-align:left">
                                    ...
                                    <table border="0" cellspacing="0" cellpadding="0" dir="ltr">
                                        <tbody>
                                            <tr>
                                                <td>
                                                    <p style="text-align:left;color:#333333;font-family:Arial,Helvetica,sans-serif;font-size:15px;line-height:22px;margin:0px;padding:0;margin-top:10px;font-weight:normal">We've got new learning interest from <b>${firstname}</b>.
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>
                                                    ...
                                                    <p style="text-align:left;color:#333333;font-family:Arial,Helvetica,sans-serif;font-size:15px;line-height:22px;margin:0px;padding:0;margin-top:10px;font-weight:normal">Preferred Time: <b>${date}</b></p>
                                                    <p style="text-align:left;color:#333333;font-family:Arial,Helvetica,sans-serif;font-size:15px;line-height:22px;margin:0px;padding:0;margin-top:10px;font-weight:normal">Time Slot: <b>${time}</b></p>
                                                    ...
                                                    <p style="text-align:left;color:#333333;font-family:Arial,Helvetica,sans-serif;font-size:15px;line-height:22px;margin:0px;padding:0;margin-top:10px;font-weight:normal">Message/Query: <b>${query}</b></p>
      ...
      message => alert("Form Submission Successfull!")
    );
}
